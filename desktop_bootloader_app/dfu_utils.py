...
class dfu_host:
    ...
    def __generate_prog_info_packet(self, filepath: str) -> bytes:
        ...
        crc = self.__generate_crc_for_file(filepath)
    ...
    def __generate_crc_for_file(self, filepath:str) -> int:
...
if __name__ == '__main__':
    dfu = dfu_host()
    dfu.open('COM3')
    dfu.upload_file(r'C:/Users/Sahil/Documents/GitHub/robotic-hid/hardware_code/Debug/robotic-hid.bin')
    dfu.close()
